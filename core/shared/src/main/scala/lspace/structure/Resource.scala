...
//  }
  ...
  def hasLabel[L](label: ClassType[L]*): Option[Resource[L]] = {
    val _labels = labels
    if (
      _labels.exists(tpe => label.contains(tpe)) || {
  ...
  import shapeless.<:!<
  def addOut[V, V0, VT0 <: ClassType[Any]](key: String, value: V)(implicit
    @unused ev1: V <:!< ClassType[Any],
    dt: ClassTypeable.Aux[V, V0, VT0]
  ): Task[Edge[T, V0]] =
    addOut[V, V0, VT0](
      graph.ns.properties
        .cached(key)
  ...
  def addOut[V, V0, VT0 <: ClassType[Any]](key: Property, value: V)(implicit
    @unused ev1: V <:!< ClassType[Any],
    ct: ClassTypeable.Aux[V, V0, VT0]
  ): Task[Edge[T, V0]] =
    for {
  ...
  // TODO: cleanup types
  def addOut[V, R[Z] <: ClassType[Z]](key: Property, dt: R[V], value: V)(implicit
    @unused ev1: V <:!< ClassType[Any]
  ): Task[Edge[T, V]] =
    for {
      toResource <- value match {
...
//    val toResource = graph.ns.classtypes.store(value)
  ...
  def addIn[V, V0, VT0 <: ClassType[_]](key: String, value: V)(implicit
    ev1: V <:!< ClassType[_],
    dt: ClassTypeable.Aux[V, V0, VT0]
  ): Task[Edge[V0, T]] =
    addIn[V, V0, VT0](
  ...
  def addIn[V, V0, VT0 <: ClassType[_]](key: Property, value: V)(implicit
    @unused ev1: V <:!< ClassType[_],
    ct: ClassTypeable.Aux[V, V0, VT0]
  ): Task[Edge[V0, T]] =
    for {
      toResource <- value match {
  ...
  def addIn[V, R[Z] <: ClassType[Z]](key: Property, dt: R[V], value: V)(implicit
    @unused ev1: V <:!< ClassType[_]
  ): Task[Edge[V, T]] =
    for {
      toResource <- value match {
