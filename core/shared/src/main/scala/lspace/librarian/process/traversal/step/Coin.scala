...
object Coin extends StepDef("Coin") with StepWrapper[Coin] {
  ...
  object keys {
    private val pNode =
      MemGraphDefault.ns.upsertNode("sptth/tbd.tld/librarian/step/Coin/p")
    ...
    val pDouble: TypedProperty[Double] = p + DataType.default.doubleType

    private val seedNode =
      MemGraphDefault.ns.upsertNode("sptth/tbd.tld/librarian/step/Coin/seed")
    ...
    val seedInt: TypedProperty[Int] = seed + DataType.default.intType
  }
