...
import lspace.librarian.process.traversal.LabelStepTypes
...
object Selector2 {
  ...
  implicit def selector2ToSelection2[A,
                                     Aname <: String,
                                     B,
                                     Bname <: String,
                                     As1,
                                     ...
                                     SelectedTypes <: HList,
                                     TypesTuple](
      selector: Selector2[A, Aname, B, Bname, As[As1, As1name] :: As[As2, As2name] :: HNil])(
      implicit
  ...
  implicit def selector2ToSelection1[A,
                                     Aname <: String,
                                     B,
                                     Bname <: String,
                                     As1,
                                     As1name <: String,
                                     SelectedTypes <: HList,
                                     TypesTuple](selector: Selector2[A, Aname, B, Bname, As[As1, As1name] :: HNil])(
      implicit
...
object Selector3 {
  ...
  implicit def selector3ToSelection3[A,
                                     Aname <: String,
                                     B,
                                     Bname <: String,
                                     C,
                                     ...
                                     SelectedTypes <: HList,
                                     TypesTuple](
      selector: Selector3[A,
                          Aname,
                          B,
                          Bname,
                          C,
                          Cname,
                          As[As1, As1name] :: As[As2, As2name] :: As[As3, As3name] :: HNil])(
      implicit
  ...
  implicit def selector3ToSelection2[A,
                                     Aname <: String,
                                     B,
                                     Bname <: String,
                                     C,
                                     ...
                                     SelectedTypes <: HList,
                                     TypesTuple](
      selector: Selector3[A, Aname, B, Bname, C, Cname, As[As1, As1name] :: As[As2, As2name] :: HNil])(
      implicit
      reverse: Reverse.Aux[As[As1, As1name] :: As[As2, As2name] :: HNil, RLabels],
      lub: LUBConstraint[RLabels, As[_, _]],
      mapper: Mapper.Aux[LabelStepTypes.type, RLabels, SelectedTypes],
    ...
    : Selection[As[As1, As1name] :: As[As2, As2name] :: HNil, TypesTuple] =
    Selection[As[As1, As1name] :: As[As2, As2name] :: HNil, TypesTuple](selector.sl)
  implicit def selector3ToSelection1[A,
                                     Aname <: String,
                                     B,
                                     Bname <: String,
                                     C,
                                     ...
                                     SelectedTypes <: HList,
                                     TypesTuple](
      selector: Selector3[A, Aname, B, Bname, C, Cname, As[As1, As1name] :: HNil])(
      implicit
      lub: LUBConstraint[As[As1, As1name] :: HNil, As[_, _]],
      mapper: Mapper.Aux[LabelStepTypes.type, As[As1, As1name] :: HNil, SelectedTypes])
    : Selection[As[As1, As1name] :: HNil, As1] =
