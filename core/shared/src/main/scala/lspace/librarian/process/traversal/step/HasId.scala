...
object HasId extends StepDef("HasId") with StepWrapper[HasId] {
  ...
  object keys {
    private val idNode =
      MemGraphDefault.ns.upsertNode("sptth/tbd.tld/librarian/step/HasId/Id")
    ...
    idNode --- Property.default.range --> DataType.default.longType

    lazy val id: Property           = Property(idNode)
    val idLong: TypedProperty[Long] = id + DataType.default.longType
  }
