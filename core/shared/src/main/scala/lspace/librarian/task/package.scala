...
import lspace.structure.{Resource, Value}
...
//        .asInstanceOf[T]
    ...
    def Max[R <: Resource[_]](stream: Stream[Librarian[R]]): Stream[Librarian[R]] = {
      stream
        .reduceOption[Librarian[R]] {
          case (r1, r2) =>
    ...
    def Min[R <: Resource[_]](stream: Stream[Librarian[R]]): Stream[Librarian[R]] = {
      stream
        .reduceOption[Librarian[R]] {
          case (r1, r2) =>
            r1.get.value -> r2.get.value match {
