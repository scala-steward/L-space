...
//    val types = node.labels
    for {
      steps0 <- Task
        ...
        .map(_.foldLeft[HList](HNil) { case (hlist, step) =>
          step :: hlist
        })
    } yield new Traversal[ClassType[Any], ClassType[Any], HList](steps0)(ClassType.stubAny, ClassType.stubAny)
  ...
  implicit class TraversalMod[Start, ST[+Z] <: ClassType[Z], End, ET[+Z] <: ClassType[Z], Steps <: HList](
    ...
    def G(graph: Graph*): Traversal[ST[Start], GraphType[Graph], step.G :: Steps] =
      Traversal[ST[Start], GraphType[Graph], G :: Steps](step.G(graph.toList) :: _traversal.steps)(
        st,
        GraphType.datatype
      )
    ...
    def V[T, OutC, Out <: ClassType[OutC]](value: T, values: T*)(implicit
  ...
  trait BaseMod[Start, ST[+Z] <: ClassType[Z], End, ET[+Z] <: ClassType[Z], Steps <: HList] {
    ...
    protected def add[S <: Step](step: S) =
      new Traversal[ST[Start], ET[End], S :: Steps](step :: _traversal.steps)(st, et)
    protected def add[S <: Step, ST <: ClassType[Any], ET <: ClassType[Any]](
      step: S,
      st: ST,
      et: ET
...
//      add(Has(label, values.toList))
    ...
    def hasLabel[T <: DataType[_], End1, ET1 <: ClassType[_]](label: T)(implicit
      et: ClassTypeable.Aux[T, End1, ET1]
...
//      add(HasLabel(label0 :: Nil), st, et.ct)
    def hasLabels[ET0 <: ClassType[_], End1, ET1 <: ClassType[_]](label0: ET0, label1: ET0)(implicit
      et: ClassTypeable.Aux[ET0, End1, ET1]
    ): Traversal[ST[Start], ET1, HasLabel :: Steps] =
...
//      add(Coin(traversal(Traversal[ET[End], ET[End]](et, et))))
    ...
    def constant[T, T0, TT0 <: ClassType[_]](p: T)(implicit
      ct: ClassTypeable.Aux[T, T0, TT0]
    ): Traversal[ST[Start], TT0, Constant[T] :: Steps] =
  ...
  trait MoveMapStepsHelper[Start, ST[+Z] <: ClassType[Z], End, ET[+Z] <: ClassType[Z], Steps <: HList]
    ...
    def outMap(
      ...
      ff: (Property.default.type => Property)*
    ): Traversal[ST[Start], MapType[Map[Property, List[Any]]], OutMap :: Steps] =
      add(
        OutMap((f :: ff.toList).map(_.apply(Property.default)).toSet),
        st,
        MapType(DataType.default.`@property`, ListType())
      )
    ...
    def inMap(
      ...
      add(
        InMap((f :: ff.toList).map(_.apply(Property.default)).toSet),
        st,
        MapType(DataType.default.`@property`, ListType())
      )
...
//      add(Out(Set(key.key)), st, ClassType.stubAny).hasLabel[V](et)
    def out[V, End1, ET1 <: ClassType[End1]](key: TypedProperty[V], p: P[V])(implicit
      et: ClassTypeable.Aux[V, End1, ET1]
    ) =
  ...
  implicit class WithGroupStepHelper[Start, ST[+Z] <: ClassType[Z], End, ET[+Z] <: ClassType[Z], KOut, CK <: ClassType[
    _
  ], KeySteps <: HList, Steps <: HList](
    protected[this] val _traversal: Traversal[ST[Start], TupleType[(KOut, List[End])], Group[CK, KeySteps, ET[
      End
    ], HNil] :: Steps]
...
//    implicit def traversal[End] = at[ClassType[End]](t => 1.asInstanceOf[End])
  ...
  implicit class WithProjectStepHelper[Start, ST[+Z] <: ClassType[Z], End, ET[+Z] <: ClassType[Z], PST <: ClassType[
    Any
  ], PET <: ClassType[Any], PHSteps <: HList, PROJECTIONS <: HList, Steps <: HList](
    protected[this] val _traversal: Traversal[ST[Start], ET[End], Project[
    ...
    def by[P <: ClassType[
      Any
    ], PSteps <: HList, ALLPROJECTIONS <: HList, Out <: HList, EndH <: HList, REndH <: HList, End0](
      value: Traversal[PST, PST, HNil] => Traversal[PST, P, PSteps]
    )(implicit
      prepend: Prepend.Aux[Traversal[PST, P, PSteps] :: HNil, Traversal[
        PST,
        PET,
        PHSteps
      ] :: PROJECTIONS, ALLPROJECTIONS],
      datatypeMapper: shapeless.ops.hlist.Mapper.Aux[ProjectStepDataTypeMapper.type, ALLPROJECTIONS, Out],
      typeMapper: shapeless.ops.hlist.Mapper.Aux[
...
//    def drop(): Traversal[ST[Start], ET[End], Drop :: Steps] = add(Drop)
    ...
    def group[CK <: ClassType[Any], KSteps <: HList, KOut, CKOut <: ClassType[Any]](
      ...
      Group[CK, KSteps, ET[End], HNil] :: Steps
    ] /*: Traversal[ST[Start],
                 TupleType[(KOut, List[End])],
...
//        ev2: Labels1 =:= Labels2,
    ...
    def repeat[ET0 <: ClassType[_]](
      ...
      until: Traversal[ET0, ET0, HNil] => Traversal[ET0, _ <: ClassType[_], _ <: HList] = null
...
//        ev2: Labels1 =:= Labels2,
      et0: ClassTypeable.Aux[ET0, End1, ET1]
    ): Traversal[ST[Start], ET1, Choose[ET[End], ET0] :: Steps] = {
...
//        ev2: Labels1 =:= Labels2,
    ...
    def path: Traversal[ST[Start], ListType[List[Any]], Path[ClassType[Any], HNil] :: Steps] =
      add(
        Path(Traversal[ET[End], ListType[List[Any]]](et, ListType(ClassType.stubAny))),
        st,
...
//      is(P.eqv(value)(ct))
  ...
  trait ClipStepsHelper[Start, ST[+Z] <: ClassType[Z], End, ET[+Z] <: ClassType[Z], Steps <: HList]
    ...
    ): Traversal[ST[Start], ET[End], Order :: Steps] = {
      val byTraversal = by(Traversal[ET[End], ET[End]](et, et))
    ...
    /** compares to the value of the first result
      ...
      * @return
      */
    def max[CT <: DataType[_]: Orderable](
      by: Traversal[ET[End], ET[End], HNil] => Traversal[ET[End], CT, _ <: HList]
    ...
    /** compares to the value of the first result
      ...
      * @return
      */
    def min[CT <: DataType[_]: Orderable](
      by: Traversal[ET[End], ET[End], HNil] => Traversal[ET[End], CT, _ <: HList]
...
//  }
  trait NodeStepsHelper[Start, ST[+Z] <: ClassType[Z], ET[+Z] <: ClassType[Z], Steps <: HList]
    ...
    def label(key: String, keys: String*): Traversal[ST[Start], IriType[Ontology], Label :: Steps] =
      add(
        Label((key :: keys.toList).map(key => Ontology.ontologies.get(key).getOrElse(Ontology(key))).toSet),
        st,
...
//  }
  trait EdgeStepsHelper[Start, ST[+Z] <: ClassType[Z], ET[+Z] <: ClassType[Z], Steps <: HList, In, Out]
    ...
    def from[InC, InCT <: ClassType[InC]](implicit
      ct: ClassTypeable.Aux[In, InC, InCT]
    ): Traversal[ST[Start], InCT, From :: Steps] =
      add(From: From, st, ct.ct)

    def to[OutC, OutCT <: ClassType[OutC]](implicit
      ct: ClassTypeable.Aux[Out, OutC, OutCT]
...
//  }
  trait ValueStepsHelper[Start, ST[+Z] <: ClassType[Z], End, ET[+Z] <: DataType[Z], Steps <: HList]
    ...
    def label[ET0 <: ET[End], End1, ET1 <: ClassType[End1]](keys: List[ET0] = List())(implicit
      et: ClassTypeable.Aux[ET0, End1, ET1]
    ): Traversal[ST[Start], ET1, Label :: Steps] =
      add(Label(keys.toSet), st, et.ct)

    def label[ET0 <: ET[End], End1, ET1 <: ClassType[End1]](key: ET0*)(implicit
      et: ClassTypeable.Aux[ET0, End1, ET1]
    ): Traversal[ST[Start], ET1, Label :: Steps] =
...
//        extends StepsHelper[ST[Start], ET[End]] {
  implicit class WithAsAndSelectStepsHelper[Start, ST[+Z] <: ClassType[Z], End, ET[+Z] <: ClassType[
    Z
  ], Steps <: HList, Labels <: HList, SelectorOut <: Selector[_, HNil]](
    protected[this] val _traversal: Traversal[ST[Start], ET[End], Steps]
  )(implicit
    //      val st: ST,
    //          val reverse: Reverse.Aux[Steps, RSteps],
...
//  }
  ...
  trait AsAndSelectStepsHelper[Start, ST[+Z] <: ClassType[Z], End, ET[+Z] <: ClassType[
    Z
  ], Steps <: HList, Labels <: HList, SelectorOut <: Selector[_, HNil]]
      extends BaseMod[Start, ST, End, ET, Steps] {
...
//    protected[this] def _traversal: Traversal[ST[Start], ET[End], Steps]
    ...
    def select[RLabels <: HList, Types <: HList, End, End0, ET0 <: ClassType[_]](implicit
    ...
    def select[SelectedLabels <: HList, RSelectedLabels <: HList, End, End0, ET0 <: ClassType[End0]](
      label: SelectorOut => Selection[SelectedLabels, End]
    )(implicit
    ...
    def showLabels[A <: String, TypeA, OutA <: HList, End1, ET1 <: ClassType[_]](a: A): Labels = ???
    def showOutA[A <: String, TypeA, OutA, End1, ET1 <: ClassType[_]](a: A)(implicit
      outA: shapeless.ops.hlist.CollectFirst.Aux[Steps, LabelSteps.type, OutA]
    ): OutA = ???

    def select[A <: String, TypeA, OutA <: HList, End1, ET1 <: ClassType[_]](a: A)(implicit
    ...
    ): Traversal[ST[Start], ET1, Select[OutA] :: Steps] =
    ...
    def select[
      ...
      tupler: Tupler.Aux[Types, End],
      et: ClassTypeable.Aux[End, End1, ET1]
    ): Traversal[ST[Start], ET1, Select[End] :: Steps] =
      add(Select[End](List(a, b)), st, et.ct)
  }

  def apply[S: DefaultsToAny, E: DefaultsToAny]()(implicit
    cltblStart: ClassTypeable[S],
    cltblEnd: ClassTypeable[E]
  ): Traversal[cltblStart.CT, cltblEnd.CT, HNil] =
  ...
  implicit class WithTraversalStreamTyped[ST <: ClassType[Any], ET <: ClassType[Any], Steps <: HList](
    ...
    def withGraph[Out, OutCT <: ClassType[Any], F[_], FT](graph: Graph)(implicit
      tweaker: EndMapper.Aux[ET, Steps, Out, OutCT],
      guide: Guide[F],
      mapper: ResultMapper.Aux[F, ET, OutCT, FT]
    ): FT =
      mapper
...
case class Traversal[+ST <: ClassType[Any], +ET <: ClassType[Any], +Steps <: HList] protected[lspace] (steps: Steps)(
  ...
  def retype(st: ClassType[Any], et: ClassType[Any]): Traversal[ClassType[Any], ClassType[Any], _ <: HList] =
    Typer.retype(stepsList.toVector, Traversal(st, et).asInstanceOf[Traversal[ClassType[Any], ClassType[Any], HList]])
  ...
  lazy val toNode: Task[Node] = {
    for {
      ...
      _     <- if (steps.nonEmpty) node.addOut(keys.stepsNode, steps) else Task.unit
    } yield node
  }.memoizeOnSuccess
